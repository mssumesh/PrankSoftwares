...
TCHAR title [ ] = TEXT ("Mouse Clip Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("MouseClipUninstV1");
TCHAR cls1 [] = TEXT ("MouseClipPrankV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Mouse Clip Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
            if ( hFlip != NULL )
