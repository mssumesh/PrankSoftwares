...
TCHAR title [ ] = TEXT ("Key Alter Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("KeyAlterUninstV1");
TCHAR cls1 [] = TEXT ("KeyAlterV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Key Alter Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
