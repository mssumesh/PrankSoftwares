...
TCHAR title [ ] = TEXT ("Print Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("PrintPrankUninstV1");
TCHAR cls1 [] = TEXT ("PrintPrankV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Print Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
