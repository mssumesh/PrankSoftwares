...
TCHAR title [ ] = TEXT ("Window Flood Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("WindowFloodUninstV1");
TCHAR cls1 [] = TEXT ("WindowFloodPrankV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Window Flood Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
            if ( hFlip != NULL )
...
ATOM MyRegisterClass(HINSTANCE hInstance, ProgData *pd )
	...
	wcex.hIcon			= LoadIcon(wcex.hInstance, MAKEINTRESOURCE(IDI_BIG));//LoadIcon(hInstance, IDI_APPLICATION );//MAKEINTRESOURCE(IDI_BIG));
