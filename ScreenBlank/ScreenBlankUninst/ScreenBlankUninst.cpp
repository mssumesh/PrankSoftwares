...
TCHAR title [ ] = TEXT ("Screen Blank Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("ScreenBlankUninstV1");
TCHAR cls1 [] = TEXT ("ScreenBlankV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Screen Blank Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
