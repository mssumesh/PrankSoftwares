...
TCHAR title [ ] = TEXT ("Flip Screen Uninstall v 1.0");
TCHAR cls [] = TEXT ("FlipScreenUninstV1");
TCHAR cls1 [] = TEXT ("FlipScreenV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Flip Screen Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
