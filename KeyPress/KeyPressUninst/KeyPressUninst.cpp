...
TCHAR title [ ] = TEXT ("Key Press Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("KeyPressUninstV1");
TCHAR cls1 [] = TEXT ("KeyPressV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Key Press Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
