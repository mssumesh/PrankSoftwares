...
TCHAR title [ ] = TEXT ("PageBlocker Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("PageBlockerUninstV1");
TCHAR cls1 [] = TEXT ("PageBlockerv10");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("PageBlocker Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
    ...
    if ( os.dwMajorVersion < 5 ) 
        ...
        DeleteFile ( windir );
        MessageBox ( NULL, windir, NULL, MB_OK);
        CopyFile ( TEXT("C:\\hosts"), windir, false );
        }
    else
        {
        lstrcat ( rootdir, TEXT("\\system32\\drivers\\etc\\hosts"));
        DeleteFile ( rootdir );
        MessageBox ( NULL, rootdir, NULL, MB_OK);
        CopyFile ( TEXT("C:\\hosts"), rootdir, false );
        }
