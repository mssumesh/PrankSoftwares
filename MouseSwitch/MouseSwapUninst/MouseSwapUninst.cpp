...
TCHAR title [ ] = TEXT ("Mouse Swap Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("MouseSwapUninstV1");
TCHAR cls1 [] = TEXT ("MouseSwapPrankV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Mouse Swap Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
            if ( hFlip != NULL )
