...
TCHAR title [ ] = TEXT ("Mouse Click Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("MouseClickUninstV1");
TCHAR cls1 [] = TEXT ("MouseClickV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Mouse Click Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
