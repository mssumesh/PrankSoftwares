...
TCHAR title [ ] = TEXT ("Window Hide Prank Uninstall v 1.0");
TCHAR cls [] = TEXT ("WindowHideUninstV1");
TCHAR cls1 [] = TEXT ("WindowHidePrankV1");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
	...
	switch (message)
        ...
        case WM_CREATE:
            ...
            MessageBox ( pd.hDlg, TEXT ("Window Hide Prank Successfully Uninstalled!"), TEXT("Uninstall Complete!"), MB_OK | MB_ICONINFORMATION );
            if ( hFlip != NULL )
